...
import sys
wb = load_workbook('/var/lib/jenkins/workspace/Automation2/Testsuite.xlsx')
sh=wb['TestSuite'] 
test_folders_loc=[]
for sh_rowB in sh['B']:
...
input_file_name=list(map(str, sys.argv[1:]))
...
for file in input_file_name:
   ...
   if(file in test_folders_loc):
    ...
    wb.save('/var/lib/jenkins/workspace/Automation2/Testsuite.xlsx')
